...
router.post('/signup', authLimiter, upload.single('profileImage'), authController.signup);
router.post('/login', authLimiter, authController.login);
router.post('/verify-email', emailVerificationLimiter, validateEmailVerification, authController.verifyEmail);
router.post('/resend-verification', emailVerificationLimiter, validateResendEmail, authController.resendVerification);
...
router.post('/upload-avatar', upload.single('profileImage'), authController.uploadAvatar);
